        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-0">
             {steps.map((step, index) => (
                <ScrollReveal key={step.id} direction="left" delay={index * 0.1}>
                 <div 
          ...
          {/* Right Block - Visual */}
          <ScrollReveal direction="right" delay={0.2} className="sticky top-24">
            <div className="bg-[#1a1a1a] border border-[#2F2F2F] rounded-3xl p-6 md:p-10 relative overflow-hidden shadow-2xl h-[500px] flex items-center justify-center group">
