...
const Pricing: React.FC<PricingProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-[80vh]">
      <ScrollReveal className="text-center mb-16" direction="down">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
           <span className="gold-gradient-text">Plans & Pricing</span>
        </h1>
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-lg mb-10 leading-relaxed font-light">
             Flexible pricing options designed for startups, growing agencies, and large enterprises.
        </p>
