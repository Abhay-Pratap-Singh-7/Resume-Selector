    ...
    <section className="py-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <ScrollReveal direction="left" delay={0.1} className="h-full">
            <div className="bg-[#1a1a1a] border border-[#2F2F2F] rounded-3xl p-8 hover-glow-border transition-colors group relative overflow-hidden min-h-[400px] flex flex-col h-full">
        ...
        <ScrollReveal direction="right" delay={0.2} className="h-full">
            <div className="bg-[#1a1a1a] border border-[#2F2F2F] rounded-3xl p-8 hover-glow-border transition-colors relative overflow-hidden min-h-[400px] flex flex-col group h-full">
                <div className="relative z-10 mb-6">
                    <div className="w-10 h-10 rounded-full bg-[#111] border border-[#2F2F2F] flex items-center justify-center mb-4 group-hover:border-[#FFCB74]/50 transition-colors">
        ...
        <ScrollReveal direction="left" delay={0.3} className="h-full">
            <div className="bg-[#1a1a1a] border border-[#2F2F2F] rounded-3xl p-8 hover-glow-border transition-colors min-h-[320px] flex flex-col overflow-hidden relative group h-full">
                <div className="relative z-10 mb-6">
                    <div className="w-10 h-10 rounded-full bg-[#111] border border-[#2F2F2F] flex items-center justify-center mb-4 group-hover:border-[#FFCB74]/50 transition-colors">
        ...
        <ScrollReveal direction="right" delay={0.4} className="h-full">
            <div className="bg-[#1a1a1a] border border-[#2F2F2F] rounded-3xl p-8 hover-glow-border transition-colors min-h-[320px] relative overflow-hidden flex flex-col group h-full">
                <div className="relative z-10 mb-6">
                    <div className="w-10 h-10 rounded-full bg-[#111] border border-[#2F2F2F] flex items-center justify-center mb-4 group-hover:border-[#FFCB74]/50 transition-colors">
